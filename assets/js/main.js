  ...
  window.openCertModal = function(certType) {
    ...
    if (certType === 'gst') {
        ...
        <div class="space-y-4 text-left">
          <div class="p-4 bg-[#F4F5F0] rounded-xl border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-700">
              ...
              <div><strong class="text-gray-900">GSTIN:</strong> 18AULPD4220A2Z8</div>
      ...
      certContent.innerHTML = `
        <div class="space-y-4 text-left">
          <div class="p-4 bg-[#F4F5F0] rounded-xl border border-gray-200">
            <h4 class="text-gray-900 font-bold text-base mb-2">GMC License No: 1782106287138461</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-700">
      ...
      certContent.innerHTML = `
        <div class="space-y-4 text-left">
          <div class="p-4 bg-[#F4F5F0] rounded-xl border border-gray-200">
            <h4 class="text-gray-900 font-bold text-base mb-2">UDYAM-AS-03-0093952</h4>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-gray-700">
